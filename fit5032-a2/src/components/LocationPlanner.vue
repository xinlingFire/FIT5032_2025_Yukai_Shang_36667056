...
<template>
  <section class="planner-panel" aria-labelledby="planner-heading">
    ...
    <div class="planner-actions"><button class="btn btn-outline-secondary" type="button" @click="useLocation">Use my location</button><template v-if="tokenConfigured"><button class="btn btn-outline-secondary" type="button" @click="searchPlace">Search place</button><button class="btn btn-primary" type="button" @click="planRoute">Calculate route</button></template><template v-else><a v-if="origin" class="btn btn-primary" :href="directionsUrl" target="_blank" rel="noreferrer">Plan transit route</a><button v-else class="btn btn-primary" type="button" @click="message = 'Add a starting point before requesting directions.'">Plan transit route</button><a class="btn btn-outline-secondary" :href="mapSearchUrl" target="_blank" rel="noreferrer">Search map</a></template></div>
